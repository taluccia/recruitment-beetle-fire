...
```{r}
plotSimulatedResiduals(simulationOutput = frostfire1.res)
```

```{r}
testOverdispersion(frostfire1.res)
```
...
```{r}
plotSimulatedResiduals(simulationOutput = snowfire1.res)
```

```{r}
testOverdispersion(snowfire1.res)
```
...
```{r}
plotSimulatedResiduals(simulationOutput = CMDfire1.res)
```

```{r}
testOverdispersion(CMDfire1.res)
```
...
```{r}
plotSimulatedResiduals(simulationOutput = ofrostfire1.res)
```

```{r}
testOverdispersion(ofrostfire1.res)
```
...
```{r}
plotSimulatedResiduals(simulationOutput = osnowfire1.res)
```

```{r}
testOverdispersion(osnowfire1.res)
```
...
```{r}
plotSimulatedResiduals(simulationOutput = oCMDfire1.res)
```

```{r}
testOverdispersion(oCMDfire1.res)
```
